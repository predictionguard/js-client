...
(function (replacepi) {
    ...
    })(ReplaceMethod = replacepi.ReplaceMethod || (replacepi.ReplaceMethod = {}));
    // -------------------------------------------------------------------------
    ...
    var Client = /** @class */ (function (_super) {
        ...
        Client.prototype.ReplacePI = function (prompt, replaceMethod) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.RawDoPost('PII', body)];
                        case 2:

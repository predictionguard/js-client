...
js-chat-basic: compile-ts
	node --env-file=.env examples/chat_basic.js
...
js-chat-advanced: compile-ts
	node --env-file=.env examples/chat_advanced_parameters.js

js-chat-function-calling: compile-ts
	node --env-file=.env examples/chat_function_calling.js

js-comp-sse: compile-ts
	node --env-file=.env examples/completion_sse.js

js-audio-transcription: compile-ts
	node --env-file=.env examples/audio_transcription.js

js-document-extraction: compile-ts
	node --env-file=.env examples/document_extraction.js

test-integration: compile-ts
	node --env-file=.env test/integration_test.js

test-build: compile-ts

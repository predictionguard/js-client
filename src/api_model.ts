...
/** ReasoningEffort represents reasoning effort levels for reasoning models. */
...
/** ToolChoice represents tool choice options for function calling. */
export enum ToolChoiceOptions {
    None = 'none',
    Auto = 'auto',
    Required = 'required',
}

/** TimestampGranularity represents timestamp granularity options for audio transcription. */
export enum TimestampGranularity {
    Word = 'word',
    Segment = 'segment',
}

/** AudioResponseFormat represents response format options for audio transcription. */
...
export interface ChatInput {
    ...
    /** maxTokens represents the max number of tokens to return. @deprecated Use maxCompletionTokens instead. */
    maxTokens?: number;
    ...
    toolChoice?: ToolChoiceOptions | string | ToolChoiceFunction;
...
export interface CompletionSSEInput {
    /** model represents the model to use. */
    model: string;
    ...
    /** onMessage represents a function that will receive the messages. */
    onMessage: (event: CompletionSSE | null, err: Error | null) => void;
}

/** CompletionSSEChoice represents an object that contains a streaming result choice. */
export interface CompletionSSEChoice {
...
/** CompletionSSE represents an object that contains the result for the streaming completion call. */
export interface CompletionSSE {
    /** id represents a unique identifier for the result. */
    id: string;
